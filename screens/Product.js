            ...
            <View style={{ height: '100%' }}>
                ...
                <View style={{ paddingHorizontal: 30, paddingVertical: 20, backgroundColor: 'black', height: '50%', borderTopRightRadius: 30, borderTopLeftRadius: 30, }}>
                    ...
                    <View style={{ flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
                        <Text style={{ color: 'white', fontSize:35 }}>{route.params.rating.rate}</Text>
                        <Icon name="star" size={30} color="white" />
                    </View>
                    <TouchableOpacity style={{ backgroundColor: 'white', paddingVertical: 10, borderRadius: 15, alignItems: 'center', marginTop: '10%' }}>
